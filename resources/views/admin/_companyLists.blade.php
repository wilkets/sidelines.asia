                        ...
                        @foreach($companies as $id => $company)
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <center>
                                            <a href="{{ URL::to('/', $company->user->id)}}"><button type="button" class="btn btn-default" title="View"><i class="glyphicon glyphicon-eye-open"></i></button></a>
                                            {!! Form::open(array('route' => array('admin.retrieve', $company->user->id), 'class'=>'action-btns')) !!}
                                                <button type="submit" class="btn btn-default" title="Retrieve"><i class="glyphicon glyphicon-cloud-upload"></i></button>
                                            {!! Form::close() !!}
                                            {!! Form::open(array('route' => array('admin.delete', $company->user->id), 'method' => 'delete','class'=>'action-btns')) !!}
                                                    ...
                                                    <div class="modal-dialog box box-danger" >
                                                        <div class="modal-content">
                                                          <div class="modal-header-del">
                                                              <h3 class="modal-del-text"><center>This will permanently delete this company in the database.<br/> Are you sure you want to proceed?</center></h3>
                                                          </div>
                                                          <div class="modal-footer">
                                                                <center>
                                                                    <div class="action-btns2">
                                                                        {!! Form::open(array('route' => array('admin.forcedelete', $company->user->id), 'method' => 'delete')) !!}
